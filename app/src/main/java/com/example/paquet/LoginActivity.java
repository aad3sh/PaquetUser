...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{
    ...
    public void login(View view){
        ...
        if(!scrolledUp){
            //Log.d(TAG, String.valueOf(email_login.getText().toString().length()));
    ...
    public void register(View view){
        if(!scrolledUp){
            ...
            if(email_register.getText().toString() == "" || password_register.getText().toString() == "" || first_name.getText().toString() == "" || last_name.getText().toString() == ""){
                Toast.makeText(LoginActivity.this, "Please all details above!", Toast.LENGTH_SHORT).show();
                return;
            }
            progressCL.setVisibility(View.VISIBLE);
